      ...
      return getSecret(header, function(err, secretOrPublicKey2) {
        ...
        if (options.audience) {
          ...
          var match = target.some(function(targetAudience) {
            return audiences.some(function(audience2) {
              return audience2 instanceof RegExp ? audience2.test(targetAudience) : audience2 === targetAudience;
            });
          });
          if (!match) {
...
var require_lru_cache = __commonJS({
  "node_modules/lru-memoizer/node_modules/lru-cache/lib/lru-cache.js"(exports, module2) {
...
var require_lib = __commonJS({
  "node_modules/lru-memoizer/lib/index.js"(exports, module2) {
    "use strict";
...
// node_modules/@serverless-jwt/jwt-verifier/dist/errors.js
var require_errors = __commonJS({
  "node_modules/@serverless-jwt/jwt-verifier/dist/errors.js"(exports) {
    "use strict";
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.JwtVerifierError = exports.ConfigurationError = void 0;
    var ConfigurationError = function(_super) {
      __extends(ConfigurationError2, _super);
      function ConfigurationError2(message) {
    ...
    var JwtVerifierError = function(_super) {
      __extends(JwtVerifierError2, _super);
      function JwtVerifierError2(code, message) {
        var _this = _super.call(this, message) || this;
        Object.setPrototypeOf(_this, JwtVerifierError2.prototype);
        _this.code = code;
        return _this;
      }
      return JwtVerifierError2;
    }(Error);
    exports.JwtVerifierError = JwtVerifierError;
  }
});

// node_modules/wretch/dist/bundle/wretch.js
var require_wretch = __commonJS({
  "node_modules/wretch/dist/bundle/wretch.js"(exports, module2) {
    !function(t, r) {
      typeof exports == "object" && typeof module2 != "undefined" ? module2.exports = r() : typeof define == "function" && define.amd ? define(r) : (t = typeof globalThis != "undefined" ? globalThis : t || self).wretch = r();
    }(exports, function() {
      "use strict";
      var t = function() {
        return t = Object.assign || function(t2) {
          for (var r2, e2 = 1, n2 = arguments.length; e2 < n2; e2++)
            for (var o2 in r2 = arguments[e2])
              Object.prototype.hasOwnProperty.call(r2, o2) && (t2[o2] = r2[o2]);
          return t2;
        }, t.apply(this, arguments);
      };
      function r(t2, r2, e2) {
        if (e2 || arguments.length === 2)
          for (var n2, o2 = 0, i2 = r2.length; o2 < i2; o2++)
            !n2 && o2 in r2 || (n2 || (n2 = Array.prototype.slice.call(r2, 0, o2)), n2[o2] = r2[o2]);
        return t2.concat(n2 || Array.prototype.slice.call(r2));
      }
      var e = function(n2, o2, i2) {
        if (i2 === void 0 && (i2 = false), !n2 || !o2 || typeof n2 != "object" || typeof o2 != "object")
          return n2;
        var s2 = t({}, n2);
        for (var u2 in o2)
          o2.hasOwnProperty(u2) && (o2[u2] instanceof Array && n2[u2] instanceof Array ? s2[u2] = i2 ? r(r([], n2[u2], true), o2[u2], true) : o2[u2] : typeof o2[u2] == "object" && typeof n2[u2] == "object" ? s2[u2] = e(n2[u2], o2[u2], i2) : s2[u2] = o2[u2]);
        return s2;
      }, n = { defaults: {}, errorType: null, polyfills: { fetch: null, FormData: null, URLSearchParams: null, performance: null, PerformanceObserver: null, AbortController: null }, polyfill: function(t2, e2) {
        for (var n2 = e2 === void 0 ? {} : e2, o2 = n2.doThrow, i2 = o2 === void 0 || o2, s2 = n2.instance, u2 = s2 !== void 0 && s2, c2 = [], a2 = 2; a2 < arguments.length; a2++)
          c2[a2 - 2] = arguments[a2];
        var f2 = this.polyfills[t2] || (typeof self != "undefined" ? self[t2] : null) || (typeof global != "undefined" ? global[t2] : null);
        if (i2 && !f2)
          throw new Error(t2 + " is not defined");
        return u2 && f2 ? new (f2.bind.apply(f2, r([void 0], c2, false)))() : f2;
      } }, o = function(t2, r2, e2, n2) {
        if (!t2.getEntriesByName)
          return false;
        ...
        if (t2 && r2) {
          ...
          (function(t3, r3) {
            return !i.observer && t3 && r3 && (i.observer = new r3(function(r4) {
              i.callbacks.forEach(function(e3, n2) {
                o(r4, n2, e3, t3);
              });
            }), t3.clearResourceTimings && t3.clearResourceTimings()), i.observer;
          })(e2, n.polyfill("PerformanceObserver", { doThrow: false })) && (o(e2, t2, r2, e2) || (i.callbacks.size < 1 && i.observer.observe({ entryTypes: ["resource", "measure"] }), i.callbacks.set(t2, r2)));
        }
      } }, s = function(t2) {
        this.error = t2;
      }, u = "Content-Type";
      function c(t2) {
        var r2;
        return t2 === void 0 && (t2 = {}), (r2 = Object.entries(t2).find(function(t3) {
          return t3[0].toLowerCase() === u.toLowerCase();
        })) === null || r2 === void 0 ? void 0 : r2[1];
      }
      function a(t2) {
        return /^application\/.*json.*/.test(t2);
      }
      var f = function() {
        ...
        }, o2.prototype.selfFactory = function(e2) {
          var n2 = e2 === void 0 ? {} : e2, i2 = n2.url, s2 = i2 === void 0 ? this._url : i2, u2 = n2.options, c2 = u2 === void 0 ? this._options : u2, a2 = n2.catchers, f2 = a2 === void 0 ? this._catchers : a2, l2 = n2.resolvers, p2 = l2 === void 0 ? this._resolvers : l2, h2 = n2.middlewares, d2 = h2 === void 0 ? this._middlewares : h2, y = n2.deferredChain, v = y === void 0 ? this._deferredChain : y;
          return new o2(s2, t({}, c2), new Map(f2), r([], p2, true), r([], d2, true), r([], v, true));
        }, o2.prototype.defaults = function(t2, r2) {
          return r2 === void 0 && (r2 = false), n.defaults = r2 ? e(n.defaults, t2) : t2, this;
        }, o2.prototype.errorType = function(t2) {
          return n.errorType = t2, this;
        }, o2.prototype.polyfills = function(r2) {
          return n.polyfills = t(t({}, n.polyfills), r2), this;
        }, o2.prototype.url = function(t2, r2) {
          if (r2 === void 0 && (r2 = false), r2)
            return this.selfFactory({ url: t2 });
          var e2 = this._url.split("?");
          return this.selfFactory({ url: e2.length > 1 ? e2[0] + t2 + "?" + e2[1] : this._url + t2 });
        }, o2.prototype.options = function(t2, r2) {
          return r2 === void 0 && (r2 = true), this.selfFactory({ options: r2 ? e(this._options, t2) : t2 });
        }, o2.prototype.query = function(t2, r2) {
          return r2 === void 0 && (r2 = false), this.selfFactory({ url: l(this._url, t2, r2) });
        }, o2.prototype.headers = function(t2) {
          return this.selfFactory({ options: e(this._options, { headers: t2 || {} }) });
        }, o2.prototype.accept = function(t2) {
          return this.headers({ Accept: t2 });
        }, o2.prototype.content = function(t2) {
          var r2;
          return this.headers(((r2 = {})["Content-Type"] = t2, r2));
        }, o2.prototype.auth = function(t2) {
          return this.headers({ Authorization: t2 });
        }, o2.prototype.catcher = function(t2, r2) {
          var e2 = new Map(this._catchers);
          return e2.set(t2, r2), this.selfFactory({ catchers: e2 });
        }, o2.prototype.signal = function(r2) {
          return this.selfFactory({ options: t(t({}, this._options), { signal: r2.signal }) });
        }, o2.prototype.resolve = function(t2, e2) {
          return e2 === void 0 && (e2 = false), this.selfFactory({ resolvers: e2 ? [t2] : r(r([], this._resolvers, true), [t2], false) });
        }, o2.prototype.defer = function(t2, e2) {
          return e2 === void 0 && (e2 = false), this.selfFactory({ deferredChain: e2 ? [t2] : r(r([], this._deferredChain, true), [t2], false) });
        }, o2.prototype.middlewares = function(t2, e2) {
          return e2 === void 0 && (e2 = false), this.selfFactory({ middlewares: e2 ? t2 : r(r([], this._middlewares, true), t2, true) });
        }, o2.prototype.method = function(r2, o3, u2) {
          o3 === void 0 && (o3 = {}), u2 === void 0 && (u2 = null);
          var f2 = this.options(t(t({}, o3), { method: r2 })), l2 = c(f2._options.headers), p2 = typeof u2 == "object" && (!f2._options.headers || !l2 || a(l2));
          return function(t2) {
            var r3 = t2._url, o4 = t2._catchers, u3 = t2._resolvers, c2 = t2._middlewares, a2 = t2._options, f3 = new Map(o4), l3 = e(n.defaults, a2), p3 = n.polyfill("AbortController", { doThrow: false, instance: true });
            !l3.signal && p3 && (l3.signal = p3.signal);
            var h2 = { ref: null, clear: function() {
              h2.ref && (clearTimeout(h2.ref), h2.ref = null);
            } }, d2 = function(t3) {
              return function(r4) {
                return t3.length === 0 ? r4 : t3.length === 1 ? t3[0](r4) : t3.reduceRight(function(e2, n2, o5) {
                  return o5 === t3.length - 2 ? n2(e2(r4)) : n2(e2);
                });
              };
            }(c2)(n.polyfill("fetch"))(r3, l3), y = d2.catch(function(t3) {
              throw new s(t3);
            }).then(function(t3) {
              if (h2.clear(), !t3.ok) {
                if (t3.type === "opaque") {
                  var r4 = new Error("Opaque response");
                  throw r4.status = t3.status, r4.response = t3, r4;
                }
                return t3[n.errorType || "text"]().then(function(r5) {
                  var e2 = new Error(r5);
                  throw e2[n.errorType || "text"] = r5, e2.status = t3.status, e2.response = t3, e2;
                });
              }
              return t3;
            }), v = function(r4) {
              return r4.catch(function(r5) {
                h2.clear();
                var e2 = r5 instanceof s ? r5.error : r5;
                if (r5 instanceof s && f3.has("__fromFetch"))
                  return f3.get("__fromFetch")(e2, t2);
                if (f3.has(e2.status))
                  return f3.get(e2.status)(e2, t2);
                if (f3.has(e2.name))
                  return f3.get(e2.name)(e2, t2);
                throw e2;
              });
            }, m = function(t3) {
              return function(r4) {
                return v(t3 ? y.then(function(r5) {
                  return r5 && r5[t3]();
                }).then(function(t4) {
                  return r4 ? r4(t4) : t4;
                }) : y.then(function(t4) {
            ...
            }, b = { res: m(null), json: m("json"), blob: m("blob"), formData: m("formData"), arrayBuffer: m("arrayBuffer"), text: m("text"), perfs: function(t3) {
              return d2.then(function(r4) {
                return i.observe(r4.url, t3);
              }).catch(function() {
              }), b;
            }, setTimeout: function(t3, r4) {
              return r4 === void 0 && (r4 = p3), h2.clear(), h2.ref = setTimeout(function() {
                return r4.abort();
              }, t3), b;
            }, controller: function() {
              return [p3, b];
            }, error: function(t3, r4) {
              return f3.set(t3, r4), b;
            }, badRequest: function(t3) {
              return b.error(400, t3);
            }, unauthorized: function(t3) {
              return b.error(401, t3);
            }, forbidden: function(t3) {
              return b.error(403, t3);
            }, notFound: function(t3) {
              return b.error(404, t3);
            }, timeout: function(t3) {
              return b.error(408, t3);
            }, internalError: function(t3) {
              return b.error(500, t3);
            }, fetchError: function(t3) {
              return b.error("__fromFetch", t3);
            }, onAbort: function(t3) {
              return b.error("AbortError", t3);
            } };
            return u3.reduce(function(r4, e2) {
              return e2(r4, t2);
            }, b);
          }((f2 = u2 ? p2 ? f2.json(u2, l2) : f2.body(u2) : f2)._deferredChain.reduce(function(t2, r3) {
            return r3(t2, t2._url, t2._options);
          }, f2));
        }, o2.prototype.get = function(t2) {
          return this.method("GET", t2);
        }, o2.prototype.delete = function(t2) {
          return this.method("DELETE", t2);
        }, o2.prototype.put = function(t2, r2) {
          return this.method("PUT", r2, t2);
        }, o2.prototype.post = function(t2, r2) {
          return this.method("POST", r2, t2);
        }, o2.prototype.patch = function(t2, r2) {
          return this.method("PATCH", r2, t2);
        }, o2.prototype.head = function(t2) {
          return this.method("HEAD", t2);
        }, o2.prototype.opts = function(t2) {
          return this.method("OPTIONS", t2);
        }, o2.prototype.replay = function(t2) {
          return this.method(this._options.method, t2);
        }, o2.prototype.body = function(r2) {
          return this.selfFactory({ options: t(t({}, this._options), { body: r2 }) });
        }, o2.prototype.json = function(t2, r2) {
          var e2 = c(this._options.headers);
          return this.content(r2 || a(e2) && e2 || "application/json").body(JSON.stringify(t2));
        }, o2.prototype.formData = function(t2, r2) {
          return r2 === void 0 && (r2 = false), this.body(p(t2, r2));
        }, o2.prototype.formUrl = function(t2) {
          return this.body(typeof t2 == "string" ? t2 : (r2 = t2, Object.keys(r2).map(function(t3) {
            var e2 = r2[t3];
            return e2 instanceof Array ? e2.map(function(r3) {
              return h(t3, r3);
            }).join("&") : h(t3, e2);
        ...
        if (typeof r2 == "string")
          ...
          var i2 = n.polyfill("URLSearchParams", { instance: true });
          for (var s2 in r2)
            if (r2[s2] instanceof Array)
              for (var u2 = 0, c2 = r2[s2]; u2 < c2.length; u2++) {
                var a2 = c2[u2];
                i2.append(s2, a2);
              }
            else
        ...
        var f2 = t2.split("?");
        return o2 ? e2 || f2.length < 2 ? f2[0] + "?" + o2 : t2 + "&" + o2 : e2 ? f2[0] : t2;
      };
      function p(t2, e2, o2, i2) {
        return e2 === void 0 && (e2 = false), o2 === void 0 && (o2 = n.polyfill("FormData", { instance: true })), i2 === void 0 && (i2 = []), Object.entries(t2).forEach(function(t3) {
          var n2 = t3[0], s2 = t3[1], u2 = i2.reduce(function(t4, r2) {
            return t4 ? "".concat(t4, "[").concat(r2, "]") : r2;
          }, null);
          if (u2 = u2 ? "".concat(u2, "[").concat(n2, "]") : n2, s2 instanceof Array)
            for (var c2 = 0, a2 = s2; c2 < a2.length; c2++) {
              var f2 = a2[c2];
              o2.append(u2 + "[]", f2);
            }
          else
            !e2 || typeof s2 != "object" || e2 instanceof Array && e2.includes(n2) ? o2.append(u2, s2) : s2 !== null && p(s2, e2, o2, r(r([], i2, true), [n2], false));
        }), o2;
      }
      function h(t2, r2) {
        return encodeURIComponent(t2) + "=" + encodeURIComponent(typeof r2 == "object" ? JSON.stringify(r2) : "" + r2);
      }
      var d = f.factory;
      return d.default = f.factory, d;
    });
  }
});
...
// node_modules/@serverless-jwt/jwt-verifier/dist/utils.js
var require_utils2 = __commonJS({
  "node_modules/@serverless-jwt/jwt-verifier/dist/utils.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function semaphore() {
      ...
      return function instance(fn) {
        if (running) {
          var res = running.then(function() {
            return fn();
          });
          running = res.then(function() {
            return void 0;
          });
          return res;
        }
...
// node_modules/@serverless-jwt/jwt-verifier/dist/metadata.js
var require_metadata = __commonJS({
  "node_modules/@serverless-jwt/jwt-verifier/dist/metadata.js"(exports) {
    "use strict";
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    var wretch_1 = __importDefault(require_wretch());
    ...
    function get(url) {
      return new Promise(function(resolve, reject) {
        wretch_1.default(url).polyfills({ fetch: cjs_ponyfill_1.abortableFetch(node_fetch_1.default).fetch, URLSearchParams: url_1.URLSearchParams, AbortController: cjs_ponyfill_1.AbortController }).get().setTimeout(1e4).json().then(function(res) {
          return resolve(res);
        }).catch(function(e) {
    ...
    var MetadataClient = function() {
      function MetadataClient2(issuer2, jwksUri) {
        this.jwksUri = jwksUri;
        this.baseUrl = issuer2.replace(/\/$/, "");
        this.metadataSemaphore = utils_1.semaphore();
      }
      MetadataClient2.prototype.getOpenIdConfiguration = function() {
        var metadataUrl = this.baseUrl + "/.well-known/openid-configuration";
        return get(metadataUrl);
      };
      MetadataClient2.prototype.getJsonWebKeySetUrl = function() {
            ...
            switch (_a.label) {
              case 0:
                if (typeof this.jwksUri !== "undefined" && this.jwksUri !== null) {
                  return [2, this.jwksUri];
                }
                return [4, this.metadataSemaphore(function() {
                  return _this.getOpenIdConfiguration();
                })];
              case 1:
                metadata = _a.sent();
      ...
      MetadataClient2.prototype.getJsonWebKeySet = function() {
        return __awaiter(this, void 0, void 0, function() {
          var jwksUri, res;
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, this.getJsonWebKeySetUrl()];
              case 1:
                jwksUri = _a.sent();
                return [4, get(jwksUri)];
              case 2:
                res = _a.sent();
                if (!res.keys) {
      ...
      return MetadataClient2;
    }();
    exports.default = MetadataClient;
  }
});

// node_modules/@serverless-jwt/jwt-verifier/dist/keystore.js
var require_keystore = __commonJS({
  "node_modules/@serverless-jwt/jwt-verifier/dist/keystore.js"(exports) {
    "use strict";
    var __awaiter = exports && exports.__awaiter || function(thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
    ...
    var KeyStore = function() {
        ...
        this.getKeyCached = cache({
          load: function(kid, callback) {
            limiter.removeTokens(1, function(limiterErr, remaining) {
              ...
              return _this.getSigningKeys().then(function(keys) {
      ...
      KeyStore2.prototype.getSigningKeys = function() {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                return [4, this.metadataClient.getJsonWebKeySet()];
              case 1:
                keys = _a.sent();
                ...
                return [2, signingKeys.map(function(signingKey) {
                  var jwk = {
                    kid: signingKey.kid,
                    nbf: signingKey.nbf,
      ...
      KeyStore2.prototype.getKey = function(kid) {
        var _this = this;
        return new Promise(function(resolve, reject) {
...
// node_modules/@serverless-jwt/jwt-verifier/dist/config.js
var require_config = __commonJS({
  "node_modules/@serverless-jwt/jwt-verifier/dist/config.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.validateConfiguration = void 0;
    function optionalFunction(setting, value) {
    ...
    function requireString(setting, value) {
    ...
    function requireUri(setting, value) {
...
// node_modules/@serverless-jwt/jwt-verifier/dist/index.js
var require_dist = __commonJS({
  "node_modules/@serverless-jwt/jwt-verifier/dist/index.js"(exports) {
    "use strict";
    var __awaiter = exports && exports.__awaiter || function(thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
    ...
    var keystore_1 = __importDefault(require_keystore());
    var errors_1 = require_errors();
    var config_1 = require_config();
    var errors_2 = require_errors();
    Object.defineProperty(exports, "ConfigurationError", { enumerable: true, get: function() {
      return errors_2.ConfigurationError;
    } });
    Object.defineProperty(exports, "JwtVerifierError", { enumerable: true, get: function() {
      return errors_2.JwtVerifierError;
    } });
    var JwtVerifier = function() {
      function JwtVerifier2(options) {
        var _this = this;
        this.keyProvider = function(header, cb) {
            ...
            return __generator(this, function(_a) {
              switch (_a.label) {
                case 0:
                  ...
                  return [4, this.keyStore.getKey(header.kid)];
                case 1:
                  jwk = _a.sent();
                  return [2, cb(null, jwk.key)];
                case 2:
                  err_1 = _a.sent();
                  return [2, cb(err_1)];
                case 3:
      ...
      JwtVerifier2.prototype.verifyAccessToken = function(jwt) {
        var _this = this;
        return new Promise(function(resolve, reject) {
          try {
            ...
            var audience2 = Array.isArray(decoded.payload.aud) ? decoded.payload.aud : [decoded.payload.aud];
            if (audience2.indexOf(_this.options.audience) === -1) {
              return reject(new errors_1.JwtVerifierError("jwt_invalid", "Invalid audience (aud) provided, got '" + audience2.join(", ") + "'"));
            }
          } catch (e) {
            return reject(new errors_1.JwtVerifierError("unknown_error", e.message));
          }
          return jsonwebtoken_1.verify(jwt, _this.keyProvider, { audience: _this.options.audience, issuer: _this.options.issuer }, function(err, decoded2) {
            return __awaiter(_this, void 0, void 0, function() {
              ...
              return __generator(this, function(_a) {
                switch (_a.label) {
                  case 0:
                    if (err) {
                      if (err.name === "TokenExpiredError") {
                        ...
                        if (expiration) {
                          return [2, reject(new errors_1.JwtVerifierError("jwt_expired", "The provided token expired at '" + expiration.toISOString() + "'"))];
                        }
                        return [2, reject(new errors_1.JwtVerifierError("jwt_expired", "The provided token expired"))];
                      }
                      if (err.name === "NotBeforeError") {
                        date = err.date;
                        if (date) {
                          return [2, reject(new errors_1.JwtVerifierError("jwt_invalid", "The provided token cannot be used before '" + date.toISOString() + "'"))];
                        }
                        return [2, reject(new errors_1.JwtVerifierError("jwt_invalid", "The provided token cannot be used yet"))];
                      }
                      return [2, reject(new errors_1.JwtVerifierError("jwt_invalid", err.message))];
                    }
                    claims = decoded2;
                  ...
                  case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4, this.options.mapClaims(claims)];
                  case 2:
                    claims = _a.sent();
                    if (typeof claims === "undefined" || claims === null) {
                      return [2, reject(new errors_1.JwtVerifierError("claims_mapping", "The mapClaims function returned an empty object"))];
                    }
                    return [3, 4];
                  case 3:
                    e_1 = _a.sent();
                    return [2, reject(new errors_1.JwtVerifierError("claims_mapping", e_1.message))];
                  case 4:
                    return [2, resolve(claims)];
                }
              });
            });
          });
    ...
    exports.claimToArray = claimToArray2;
    function removeNamespaces(namespace, claims) {
      return Object.entries(claims).map(function(_a) {
...
// node_modules/@serverless-jwt/netlify/dist/index.js
var require_dist2 = __commonJS({
  "node_modules/@serverless-jwt/netlify/dist/index.js"(exports) {
    "use strict";
    var __awaiter = exports && exports.__awaiter || function(thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
    ...
    var jwt_verifier_1 = require_dist();
            ...
            return __generator(this, function(_a) {
              switch (_a.label) {
                case 0:
                  ...
                  return [4, verifier.verifyAccessToken(accessToken)];
                case 1:
                  claims = _a.sent();
                  return [3, 3];
                case 2:
                  ...
                  if (typeof options.handleError !== "undefined" && options.handleError !== null) {
                    return [2, options.handleError(err_1)];
                  }
                  return [2, json(401, {
                    error: err_1.code,
                ...
                case 3:
                  ...
                  return [2, handler2(event, context, cb)];
              }
            });
          });
        };
    ...
    var jwt_verifier_2 = require_dist();
    Object.defineProperty(exports, "claimToArray", { enumerable: true, get: function() {
      return jwt_verifier_2.claimToArray;
    } });
    Object.defineProperty(exports, "removeNamespaces", { enumerable: true, get: function() {
      return jwt_verifier_2.removeNamespaces;
    } });
    Object.defineProperty(exports, "getTokenFromHeader", { enumerable: true, get: function() {
      return jwt_verifier_2.getTokenFromHeader;
    } });
  }
});
...
// node_modules/faunadb/node_modules/boxen/index.js
var require_boxen = __commonJS({
  "node_modules/faunadb/node_modules/boxen/index.js"(exports, module2) {
    "use strict";
    var stringWidth = require_string_width();
...
var require_query = __commonJS({
  "node_modules/faunadb/src/query.js"(exports, module2) {
    ...
    function Map3(collection, lambda_expr) {
      arity.exact(2, arguments, Map3.name);
...
var require_PageHelper = __commonJS({
  "node_modules/faunadb/src/PageHelper.js"(exports, module2) {
    ...
    var objectAssign = require_object_assign();
    function PageHelper(client2, set, params, options) {
      if (params === void 0) {
        params = {};
      }
      if (options === void 0) {
    ...
    PageHelper.prototype._retrieveNextPage = function(cursor, reverse) {
      ...
      var q = query2.Paginate(this.set, opts);
...
var require_http2Adapter = __commonJS({
  "node_modules/faunadb/src/_http/http2Adapter.js"(exports, module2) {
    ...
    var faunaErrors = require_errors2();
    var util = require_util2();
...
var require_node_abort_controller = __commonJS({
  "node_modules/node-abort-controller/index.js"(exports, module2) {
    ...
    module2.exports = { AbortController, AbortSignal };
  }
});
...
var require_fetchAdapter = __commonJS({
  "node_modules/faunadb/src/_http/fetchAdapter.js"(exports, module2) {
    "use strict";
    var { AbortController } = require_node_abort_controller();
    var util = require_util2();
    var faunaErrors = require_errors2();
    var errors = require_errors3();
    function FetchAdapter(options) {
      ...
      if (util.isNodeEnv() && options.keepAlive) {
        this._keepAliveEnabledAgent = new (options.isHttps ? require("https") : require("http")).Agent({ keepAlive: true, timeout: 3e3 });
      }
    }
...
var require_stream = __commonJS({
  "node_modules/faunadb/src/stream.js"(exports, module2) {
    ...
    function StreamClient(client2, expression, options, onEvent) {
    ...
    function StreamAPI(client2) {
      var api = function(expression, options) {
        ...
        var streamClient = new StreamClient(client2, expression, options, function(event) {
      ...
      api.document = function(expression, options) {
        ...
        var streamClient = new StreamClient(client2, expression, options, onEvent);
...
var require_Client = __commonJS({
  "node_modules/faunadb/src/Client.js"(exports, module2) {
    ...
    Client2.apiVersion = packageJson.apiVersion;
    Client2.prototype.query = function(expression, options) {
      options = Object.assign({}, this._globalQueryOptions, options);
      return this._execute("POST", "", query2.wrap(expression), null, options);
    };
    Client2.prototype.paginate = function(expression, params, options) {
      params = util.defaults(params, {});
      options = util.defaults(options, {});
      return new PageHelper(this, expression, params, options);
    };
    Client2.prototype.ping = function(scope, timeout) {
      return this._execute("GET", "ping", null, { scope, timeout });
    };
    Client2.prototype.getLastTxnTime = function() {
      return this._http.getLastTxnTime();
    };
    Client2.prototype.syncLastTxnTime = function(time) {
      this._http.syncLastTxnTime(time);
    };
    Client2.prototype.close = function(opts) {
      return this._http.close(opts);
    };
    Client2.prototype.queryWithMetrics = function(expression, options) {
      return this._execute("POST", "", query2.wrap(expression), null, options, true);
    };
    Client2.prototype._execute = function(method, path, data, query3, options, returnMetrics = false) {
    ...
    Client2.prototype._handleRequestResult = function(response, result, options) {
...
// api/functions/get-invoices.ts
var get_invoices_exports = {};
__export(get_invoices_exports, {
  handler: () => handler
});
...
var verifyJwt = (0, import_netlify.NetlifyJwtVerifier)({
  issuer: `https://${issuer}/`,
  audience,
  mapClaims: (claims) => {
    const user = JSON.parse(JSON.stringify(claims));
    user.scope = (0, import_netlify.claimToArray)(user.scope);
    return user;
  }
});
var verify_jwt_default = verifyJwt;

// api/lib/fauna.ts
var import_faunadb = __toESM(require_faunadb(), 1);
var connectToDb = () => {
  const client2 = new import_faunadb.Client({
    secret: process.env.FAUNADB_SECRET
  });
  return { client: client2, query: import_faunadb.query };
};
var fauna_default = connectToDb;

// api/functions/get-invoices.ts
var {
  client,
  query: { Paginate, Match, Index, Map: Map2, Get }
} = fauna_default();
var handler = verify_jwt_default(async (event, context) => {
  ...
  const invoices = await client.query(Map2(Paginate(Match(Index("invoices_by_user"), userId)), (ref) => Get(ref)));
  return {
    statusCode: 200,
    headers: {
...
module.exports = __toCommonJS(get_invoices_exports);
